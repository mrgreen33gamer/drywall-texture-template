  ...
  return (
    <div className={styles.thermo} aria-hidden="true">
      ...
      <div className={styles.thermoLabels}>
        <span className={styles.thermoTop}>Level 5</span>
        <span className={styles.thermoMid}>Waco, TX</span>
        <span className={styles.thermoBot}>Smooth</span>
      </div>
    </div>
  );
}

const CHIPS = ['Same-Day Patches', 'No Contracts', 'Bonded & Insured', 'Since 2009', '2-Yr Warranty'];
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.content}>
          <motion.div className={styles.badge}
            ...
            Waco&apos;s Trusted Drywall Pros — Hang · Tape · Texture · Repair
          </motion.div>

          <motion.h1 className={styles.headline}
            initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}>
            Level Walls.<br />Smooth Finish Guarantee.<br />
            <span className={styles.accentLine}>LevelWall.</span>
          </motion.h1>

          <motion.p className={styles.sub}
            initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.22 }}>
            Upfront quotes. Pro drywall crews. Smooth Finish Guarantee · 2-Year Workmanship.
            Serving Waco and Central Texas — hanging, taping, texture matching, and repairs.
          </motion.p>

          <motion.div className={styles.ctaRow}
            initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.34 }}>
            <a href="tel:+12549701818" className={styles.ctaPrimary}>
        ...
        >
          ...
          <motion.div className={`${styles.statCard} ${styles.sc1}`}
            ...
            <span className={styles.scNum}>5,000+</span>
            <span className={styles.scLbl}>Rooms Finished</span>
          </motion.div>
