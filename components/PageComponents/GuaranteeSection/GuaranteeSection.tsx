...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every job we complete is covered by a Smooth Finish Guarantee · 2-Year Workmanship. If our labor fails within two years, we make it right.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every pro who enters your home is bonded and insured. No untrained day labor — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every drywall contractor in Central Texas makes promises. We back ours in writing — with upfront pricing, pro drywall crews, and a Smooth Finish Guarantee · 2-Year Workmanship on every job we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 980+ verified Google reviews</span>
          </div>
        </div>
