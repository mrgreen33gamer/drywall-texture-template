        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— LevelWall Drywall, Waco TX</span>
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', 'Smooth Finish Guarantee · 2-Year Workmanship', 'No Contracts', 'Pro Drywall Crews'].map(b => (
