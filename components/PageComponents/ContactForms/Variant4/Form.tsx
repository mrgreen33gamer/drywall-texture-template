...
const SERVICES = [
  { icon: faFan,             label: 'Drywall Hanging',        sub: 'Everyday fixes and hardware' },
  { icon: faFire,            label: 'Taping & Finishing', sub: 'Holes, cracks, texture match' },
  { icon: faWrench,          label: 'Texture Matching',  sub: 'Sticky doors, weatherstrip, hardware' },
  { icon: faFilter,          label: 'Water Damage Drywall',     sub: 'Mounts, furniture, shelves' },
  { icon: faThermometerHalf, label: 'Popcorn Ceiling Removal',       sub: 'Tubs, windows, exterior gaps' },
  { icon: faWind,            label: 'Patch & Repair',       sub: 'Batch small projects in one visit' },
  { icon: faBolt,            label: 'Free Estimate',         sub: 'Not sure — describe the job' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A LevelWall specialist will reach out about your <strong>{selectedService}</strong> service.
                  </p>
