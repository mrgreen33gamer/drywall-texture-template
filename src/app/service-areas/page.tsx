...
// LevelWall Drywall — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day patches when schedule allows. Full drywall coverage: hanging, taping & finishing, texture matching, water damage drywall, popcorn removal, and patch & repair across all of Waco.',
    highlights:  ['Same-day patches', 'Fast dispatch', 'All services available'],
  },
  {
    city:        'Hewitt',
    slug:        'hewitt-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full drywall coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Texture matching'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same upfront pricing and Smooth Finish Guarantee · 2-Year Workmanship as every other area we cover.",
    highlights:  ['Upfront pricing', 'Smooth Finish Guarantee', 'Bonded & insured'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable drywall service for Bellmead residents and businesses. Hanging, patches, and popcorn removal — same-day when available.',
    highlights:  ['Residential & commercial', 'Pro drywall crews', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential drywall service for the China Spring area. We make the drive — upfront pricing applies just the same.',
    highlights:  ['Rural coverage', 'Upfront pricing', 'Patches available'],
  },
  {
    city:        'McGregor',
    slug:        'mcgregor-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Drywall hanging, finish, and repairs for McGregor homes and light commercial properties.',
    highlights:  ['Residential & light commercial', 'Hang & finish', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Drywall hang, tape, texture, and patch & repair for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service drywall coverage for Temple. Medical district and surrounding neighborhoods served — residential and commercial finish work.',
...
const faq = [
  ...
  },
  {
    ...
    answer: 'Yes — upfront pricing applies across every city and community we serve. The price we quote before we start is the price you pay, regardless of your location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Upfront pricing, pro drywall crews, and a Smooth Finish Guarantee · 2-Year Workmanship — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549701818" className={styles.heroCTAPrimary}>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549701818" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549701818" className={styles.unlistedCTA}>
            Call (254) 970-1818
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Upfront pricing, Smooth Finish Guarantee · 2-Year Workmanship, no contracts ever."
