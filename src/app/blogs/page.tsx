    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>LevelWall Drywall - Blog Center</h1>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need reliable drywall contractor service in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Waco-area homes and businesses comfortable with expert heating, cooling, and maintenance since 2009. Free estimate, no obligations.
            </p>
